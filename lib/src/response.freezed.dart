...
mixin _$MpdResponse {
  ...
  TResult when<TResult extends Object?>({
    required TResult Function(
            List<Map<String, String>> values, List<int>? binary)
        ok,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    TResult? Function(List<Map<String, String>> values, List<int>? binary)? ok,
...
abstract class _$$MpdResponseOkCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<Map<String, String>> values, List<int>? binary});
}
...
class _$MpdResponseOk implements MpdResponseOk {
  const _$MpdResponseOk(
      {required final List<Map<String, String>> values,
  ...
  @override
  List<Map<String, String>> get values {
